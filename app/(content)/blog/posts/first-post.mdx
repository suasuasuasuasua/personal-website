...
because I had no idea how to start, and this
[blog scaffolding](https://vercel.com/templates/next.js/nextjs-portfolio) from
...
like [Hugo](https://gohugo.io) or plain `html` or `md` files, but I'm extra and
...
_really bad_ if a real web developer came across it, but it's fineokay.
