...
1. The translation form `lua` to `nix` can be challenging. Most plugins do not
   ...
   yet.
1. My Neovim configuraiton on my MacBook is slower and less consistent than the
...
1. Rebuilding the `neovim` after each and every change sometimes tedious and
   ...
   rolling
1. To be completely honest, I have spend _too_ much time figuring out how to
