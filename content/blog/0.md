...
[Vercel](https://vercel.com/home) wasn't being helpful when I asked a
...
agent does certain things but it would take me much longer to figure it out.
Moreover, this website could have been much easier since I'm just making a
static website. I could have just used something easier like
[Hugo](https://gohugo.io) or plain `html` or `md` files, but I'm extra and
wanted to learn `typescript` and Next.js so I feel like a real software engineer
(lol).
...
I've gotten help with the following things:
...
- Refactoring codebase into `src/` folder
  ...
  - I keep forgetting that the core principle behind and power of `React` is the
    modularity and re-usability of components
...
- Setting up the blog
  - Uses [`mdx`](https://mdxjs.com) for the blog posts (basically markdown plus
    react), which are A) easy to write and B) maintains consistent formatting
  - Slug generation
...
- Setting up the portfolio
  - Links to and pulls information from my résumé GitHub repository
  - Grouped by month and year
  - Ability to download each résumé
